...
public class DentalappointmentApplication implements CommandLineRunner {
	...
	public DentalappointmentApplication(AddressService addressService, AppointmentService appointmentService,
			DentistService dentistService, PatientService patientService, SurgeryService surgeryService) {
	...
	public void run(String... args) throws Exception {
		...
		Dentist den1 = addDentist("Tony", "Smith", "000-0000-0000", "den1email", "spec1");
		Dentist den2 = addDentist("Helen", "Pearson", "000-0000-0001", "den2email", "spec2");
		Dentist den3 = addDentist("Robin", "Plevin", "000-0000-0002", "den3email", "spec3");

		Patient pan1 = addPatient("Gillian", "White", "000-0000-1000", "pat1email", add1, LocalDate.of(1999, 6, 21));
		Patient pan2 = addPatient("Jill", "Bell", "000-0000-1001", "pat2email", add2, LocalDate.of(1999, 6, 22));
		Patient pan3 = addPatient("Ian", "MacKay", "000-0000-1002", "pat3email", add3, LocalDate.of(1999, 6, 23));
		Patient pan4 = addPatient("John", "Walker", "000-0000-1003", "pat4email", add4, LocalDate.of(1999, 6, 24));
	...
	private Address addAddress(String street, String city, String state, String zip) {
		return addressService.add(new Address(null, street, city, state, zip));
	}

	private Appointment addAppointment(LocalDateTime scheduledDateTime, Patient patient, Dentist dentist,
			Surgery surgery) {
		return appointmentService
				.add(new Appointment(null, LocalDateTime.now(), scheduledDateTime, patient, surgery, dentist));
	}

	private Dentist addDentist(String firstName, String lastName, String phoneNumber, String email,
			String specialization) {
		return dentistService
				.add(new Dentist(null, firstName, lastName, phoneNumber, email, specialization, new ArrayList<>()));
	}

	private Patient addPatient(String firstName, String lastName, String phoneNumber, String email,
			Address mailingAddress, LocalDate dob) {
		return patientService
				.add(new Patient(null, firstName, lastName, phoneNumber, email, mailingAddress, dob,
						new ArrayList<>()));
	}
